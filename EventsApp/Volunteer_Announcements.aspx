<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Volunteer_Announcements.aspx.cs" Inherits="EventsApp.Volunteer_Announcements" %>
...
<body>
  ...
  <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click" >Logout</asp:LinkButton>
        ...
        <div class="container-login100" style="background-image: url('Content/bg08.jpg');">
            ...
            <br />
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Horizontal" Width="254px">
                <Columns>
                    <asp:BoundField DataField="Post" HeaderText="Event Announcements" SortExpression="Post" />
                </Columns>
            ...
            <br />
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Post] FROM [Announcements] WHERE ([Role] = @Role)">
                <SelectParameters>
