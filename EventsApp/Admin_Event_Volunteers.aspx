<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Event_Volunteers.aspx.cs" Inherits="EventsApp.Admin_Event_Volunteers" %>
...
<asp:LinkButton ID="Feedback" runat="server" OnClick="Feedback_Click"  >Feedback</asp:LinkButton>
    <asp:LinkButton ID="Logout" runat="server" OnClick="Logout_Click" >Logout</asp:LinkButton>
        ...
        <p>
            ...
            <asp:TextBox ID="EventN" runat="server"  ReadOnly="True" Width="277px" Height="30px"></asp:TextBox>
        </p>
        <p>
            <strong>Volunteers Assigned</strong></p>
        <p>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [FirstName], [LastName], [EmailAddress], [PhoneNumber] FROM [User_Details] WHERE (([Role] = @Role) AND ([Event] = @Event))">
                <SelectParameters>
                    <asp:RouteParameter DefaultValue="Volunteer" Name="Role" RouteKey="Role" Type="String" />
                    <asp:CookieParameter CookieName="cName" Name="Event" Type="String" DefaultValue="Event1" />
                </SelectParameters>
            </asp:SqlDataSource>
        </p>
        <p>
            &nbsp;</p>
        <p>
            <strong>Available Volunteers</strong></p>
        <p>
            <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="EmailAddress" DataSourceID="SqlDataSource2" ForeColor="Black" GridLines="Horizontal" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" PageSize="5">
                <Columns>
...
&nbsp;&nbsp;&nbsp;
        ...
        <p>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [FirstName], [LastName], [EmailAddress], [PhoneNumber] FROM [User_Details] WHERE (([Role] = @Role) AND ([Event] = @Event))">
                <SelectParameters>
